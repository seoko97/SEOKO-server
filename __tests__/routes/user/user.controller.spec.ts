...
describe("UserController", () => {
  ...
  describe("유저 생성", () => {
    let serviceCreateSpy: TestSpyInstance;

    beforeEach(() => {
      serviceCreateSpy = vi.spyOn(service, "create");
    });
  ...
  describe("유저 조회", () => {
    ...
    let serviceGetByIdSpy: TestSpyInstance;

    beforeEach(() => {
      serviceGetByIdSpy = vi.spyOn(service, "getById");
    });
