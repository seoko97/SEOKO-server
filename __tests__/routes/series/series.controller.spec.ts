...
describe("SeriesController", () => {
  ...
  describe("모든 시리즈 정보 요청", () => {
    let serviceGetAllSpy: TestSpyInstance;

    beforeEach(() => {
      serviceGetAllSpy = vi.spyOn(service, "getAll");
    });
  ...
  describe("특정 시리즈 정보 요청", () => {
    let serviceGetByNumIdSpy: TestSpyInstance;

    beforeEach(() => {
      serviceGetByNumIdSpy = vi.spyOn(service, "getByNumId");
    });
  ...
  describe("시리즈 정보 수정", () => {
    let serviceUpdateSpy: TestSpyInstance;

    beforeEach(() => {
      serviceUpdateSpy = vi.spyOn(service, "update");
    });
  ...
  describe("시리즈 정보 삭제", () => {
    let serviceDeleteSpy: TestSpyInstance;

    beforeEach(() => {
      serviceDeleteSpy = vi.spyOn(service, "delete");
    });
